...
if(isset($_POST['save'])){
  ...
  if($ret > 0){ 
    ...
    $query=mysqli_query($conn,"INSERT into tblstudents(firstName,lastName,otherName,emailAddress,admissionNumber,password,classId,classArmId,dateCreated) 
    value('$firstName','$lastName','$otherName','$emailAddress','$admissionNumber','$sampPass_2','$classId','$classArmId','$dateCreated')");
...
//--------------------EDIT------------------------------------------------------------
 ...
 $query=mysqli_query($conn,"update tblstudents set firstName='$firstName', lastName='$lastName',
    otherName='$otherName', emailAddress = '$emailAddress', admissionNumber='$admissionNumber',password ='$sampPass_2', classId='$classId',classArmId='$classArmId'
    where Id='$Id'");
                  ...
                  <form method="post">
                   <div class="form-group row mb-3">
                     ...
                     <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" required name="admissionNumber" pattern="AMS\d{3}" value="<?php echo $row['admissionNumber'];?>" id="exampleInputFirstName" required >
                        </div>
                    </div>
              ...
              <div class="card mb-4">
                ...
                <div class="table-responsive p-3">
                  ...
                  <?php
                      ...
                      tblstudents.lastName,tblstudents.otherName,tblstudents.emailAddress,tblstudents.admissionNumber,tblstudents.dateCreated
                      FROM tblstudents
